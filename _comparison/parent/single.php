		...
		<?php if ( have_posts() ): while ( have_posts() ) : the_post(); ?>
			...
			<div class='container<?php echo $fluid; ?>'>
				<section class='l-main post'>
					...
					<?php endif; ?>
                    	<div class="meta">
		                <p><?php echo get_the_date('F j, Y','','', FALSE); echo ' | '; the_author(); ?></p>
                        <?php /* <p class="filed-under">Filed under: <?php the_category(', '); ?></p> */ ?>
                        </div>
			...
			<div class='container<?php echo $fluid; ?> post-nav'>
